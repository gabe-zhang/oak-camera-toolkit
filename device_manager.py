# This file is from the DepthAI repository by Luxonis.
# Original source: https://github.com/luxonis/depthai-python/blob/main/utilities/device_manager.py
# Licensed under the MIT License. See https://github.com/luxonis/depthai/blob/main/LICENSE
#
# Modifications may have been made to adapt it for this project.
